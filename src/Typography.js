...
export const _TYPO_SCALE_H1 = 4;
export const _TYPO_SCALE_H2 = 3;
export const _TYPO_SCALE_H3 = 2;
export const _TYPO_SCALE_H4 = 1;
export const _TYPO_SCALE_H5 = 0;
export const _TYPO_SCALE_H6 = -0.5;
